...
function EditSuscription({ value, onConfirm, onCreate, onComplete, handleClick }) {
    const [suscriptionType, setSuscriptionType] = useState(
        value.suscription_Type
    )
    const [cost, setCost] = useState(value.cost)
    const [suscriptionDescription, setSuscriptionDescription] = useState(
        value.suscription_Description
    )
